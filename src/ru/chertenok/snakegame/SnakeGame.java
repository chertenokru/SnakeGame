...
import ru.chertenok.snakegame.objects.Apple;
import ru.chertenok.snakegame.objects.GameEffectComplitEvent;
import ru.chertenok.snakegame.objects.GameEffectObject;
import ru.chertenok.snakegame.objects.GameFieldDate;
import ru.chertenok.snakegame.objects.SnakeCheckEvent;
import ru.chertenok.snakegame.objects.Scope;
import ru.chertenok.snakegame.objects.Snake;
...
public class SnakeGame extends JPanel implements ActionListener,SnakeCheckEvent,GameEffectComplitEvent{
    ...
    public void newApple(boolean start) {
        ...
        {
            apple.setNewPosition();
           if (field.getField(apple.posX,apple.posY)!=S_NULL) b=false; else b=true;
        }
        while (!b);
    ...
    {
      int brush;
      if (draw) brush=S_SNAKE; else brush=S_NULL;
    ...
    private void drawButton(int i,Graphics g) {
     ...
     if (i==snake.getDirection())
         g.setColor(Color.YELLOW);else g.setColor(Color.WHITE);
    ...
    private class Keyboard extends KeyAdapter{
        ...
        public void keyPressed(KeyEvent keyEvent)
        {
            ...
            if ((key==KeyEvent.VK_RIGHT)&(snake.getDirection()!=snake.DIR_LEFT)) snake.setDirection(snake.DIR_RIGHT);
            if ((key==KeyEvent.VK_DOWN)&(snake.getDirection()!=snake.DIR_UP)) snake.setDirection(snake.DIR_DOWN);
            if ((key==KeyEvent.VK_LEFT)&(snake.getDirection()!=snake.DIR_RIGHT)) snake.setDirection(snake.DIR_LEFT);
